        ...
        plugins: {
            ...
            upload: {
                ...
                success: function (data, trumbowyg, $modal, values) {
                    console.log(data);
                    //trumbowyg.execCmd('insertImage', data.file);

                    if (data.success === true) {
                        $('img[src="' + data.file + '"]:not([alt])', trumbowyg.$box).attr('alt', 'test tesst');
                    } else {
                        setTimeout(function () {
                            $("span.trumbowyg-msg-error").html(data.message);
                        }, 100);
                    }


                    //trumbowyg.execCmd('insertImage', data.file);
                    //$('img[src="' + data.file + '"]:not([alt])', trumbowyg.$box).attr('alt', "test");
                }
            }
        },
        urlProtocol: false,
