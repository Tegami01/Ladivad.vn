...
namespace Identity.Models
{
    ...
    public class ApplicationUser : IdentityUser<string, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>
    {
        ...
        public long? DistrictId { get; set; }                   // Quận, huyện
        public long? ProvinceId { get; set; }                   // Tỉnh thành
        public long? WardId { get; set; }                       // Xã, phường
        public string Address { get; set; }
        public string PhoneNumber { get; set; }
        public string PassportIdentityCard { get; set; }        // Hộ chiếu hoặc chứng minh nhân dân
        public string AffiliateCode { get; set; }               // Mã liên kết


        //public virtual WithdrawalDTO Withdrawal { get; set; }


        // Tiếp thị liên kết
        //public virtual AffiliateDTO Affiliate { get; set; }
